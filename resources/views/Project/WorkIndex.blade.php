          ...
          <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div class="left-box">
              <div class="sec-title_title">
                <div id="service-title">Work Index!</div>
              </div>
              <h2 class="sec-title_heading">
                Few of Our Apps Adored <br />
                by <span> millions of users!</span>
              </h2>
            </div>
            <div class="right-box">
              <div class="sec-title_text">
                Few of our apps, adored by millions of users worldwide, <br> exemplify our commitment to creating
                engaging <br> and impactful digital experiences.
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mixitup-gallery">
          ...
          <div class="projects-one_filters">
            <ul class="filter-tabs">
              ...
              <li class="filter" data-role="button" data-filter=".web">
                Web Technology
              </li>
              <li class="filter" data-role="button" data-filter=".cloud">
                Cloud Database
              </li>
              <li class="filter" data-role="button" data-filter=".design">
                UI/UX Design
              </li>
            </ul>
          </div>
