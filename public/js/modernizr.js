...
(window.Modernizr = (function (a, b, c) {
  ...
  !E(A, "undefined") && !E(A.call, "undefined")
    ...
    (s.webp = function () {
      return (
        !!b.createElementNS && !!b.createElementNS(r.webp, "svg").createSVGRect
      );
    }),
    (s.inlinesvg = function () {
      ...
      return (
        (a.innerHTML = "<svg/>"),
        (a.firstChild && a.firstChild.namespaceURI) == r.webp
      );
    }),
    (s.smil = function () {
      return (
        !!b.createElementNS &&
        /SVGAnimate/.test(m.call(b.createElementNS(r.webp, "animate")))
      );
    }),
    (s.webpclippaths = function () {
      return (
        !!b.createElementNS &&
        /SVGClipPath/.test(m.call(b.createElementNS(r.webp, "clipPath")))
      );
    });
  for (var K in s)
    B(s, K) &&
